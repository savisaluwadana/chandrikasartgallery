        ...
        <div className="min-h-screen bg-white">
            ...
            <header className="pt-32 pb-16 px-6 lg:px-12">
                <div className="max-w-3xl mx-auto">
                    {/* Meta */}
                    <div className="flex items-center gap-4 text-xs text-black/40 mb-8">
                        {post.publishDate && (
                    ...
                    {/* Title */}
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extralight text-black leading-tight mb-8">
                        {post.title}
                    </h1>

                    {/* Author */}
                    <div className="flex items-center gap-4 pt-8 border-t border-black/[0.05]">
                        <div className="w-12 h-12 rounded-full bg-black/[0.05] border border-black/[0.05] flex items-center justify-center">
                            <span className="text-sm font-light text-black/40">
                                {post.author?.name?.charAt(0) || 'A'}
                            </span>
                        </div>
                        <div>
                            <span className="text-black font-light block">{post.author?.name || 'The Artist'}</span>
                            <span className="text-black/40 text-sm">Author</span>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <article className="px-6 lg:px-12 pb-20">
                <div className="max-w-3xl mx-auto">
                    <div className="prose prose-lg max-w-none">
                        <p className="text-lg text-black/70 leading-relaxed font-light whitespace-pre-wrap">
                            {post.content}
                        </p>
                    </div>
                </div>
            ...
            <div className="px-6 lg:px-12 pb-20">
                <div className="max-w-3xl mx-auto">
                    <div className="flex items-center justify-between py-8 border-t border-black/[0.05]">
                        <span className="text-black/40 text-sm">{post.wordCount} words</span>
                        <button
                            onClick={handleShare}
            ...
            <section className="px-6 lg:px-12 pb-20">
                <div className="max-w-3xl mx-auto">
                    <div className="rounded-2xl border border-black/[0.08] bg-black/[0.02] p-10 text-center relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-br from-[#6CD8D1]/5 to-transparent rounded-full blur-3xl" />
            ...
            <section className="border-t border-black/[0.05] py-20 px-6 lg:px-12">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <Link href="/blog" className="inline-flex items-center gap-2 px-6 py-3 border border-black/20 text-black rounded-full font-light hover:bg-black/5 transition-all">
                        View All Articles
                        <ArrowUpRight size={16} />
                    </Link>
                </div>
