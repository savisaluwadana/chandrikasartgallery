                    ...
                    <div className="prose prose-invert prose-lg max-w-none">
                        <div className="space-y-8">
                            ...
                            <section>
                                ...
                                <p className="text-white/60 leading-relaxed font-light mb-4">We may collect the following types of information:</p>
                                <ul className="list-disc pl-6 space-y-2 text-white/60 font-light">
                                    <li><strong className="text-white/80">Personal Information:</strong> Name, email address, phone number, shipping address when you make a purchase or contact us.</li>
                                    <li><strong className="text-white/80">Newsletter Subscription:</strong> Email address when you subscribe to our newsletter.</li>
                                    <li><strong className="text-white/80">Usage Data:</strong> Information about how you use our website, including pages visited and time spent.</li>
                                    <li><strong className="text-white/80">Cookies:</strong> We use cookies to enhance your browsing experience.</li>
                                </ul>
                            </section>
                            ...
                            <section>
                                <h2 className="text-2xl font-light text-white mb-4">Data Protection</h2>
                                <p className="text-white/60 leading-relaxed font-light">
                            ...
                            <section>
                                ...
                                <p className="text-white/60 leading-relaxed font-light mb-4">You have the right to:</p>
                                <ul className="list-disc pl-6 space-y-2 text-white/60 font-light">
